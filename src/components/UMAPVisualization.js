...
import { imgSrcArrAtom, trainingProgressAtom, visualizationActiveAtom } from '../GlobalState';

export default function UMAPVisualization({ width = 600, height = 400 }) {
  const svgRef = useRef();
  ...
  return (
    <div style={{ 
      ...
      <h3 style={{ marginTop: '30px', marginBottom: '20px' }}>UMAP Visualization of Training Data</h3>
      <svg 
        ref={svgRef}
        style={{
